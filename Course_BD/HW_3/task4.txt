...
values ('5', '1', 'А почему eminem\'a не включил в ролик?! Дизлайк отписка'),
('7', '1', 'А мне понравился ролик!'),
('4', '2', 'Полезный ролик, начинаем бороться с ней и следить за успехами'),
('6', '6', 'Фигня все, не верю'),
('1', '4', 'всегда знал, что самое высокое здание Burj Khalifa');
...
values ('Рэп-хиты 2018 года', '2'),
('Как победить прокрастенацию', '3'),
('Запуск ракеты в космос', '2'),
('Эволюция самых высоких зданий', '5'),
('Приготовление хачапури с Гордоном Рамзи', '4'),
('Компьютерное восстание', '10');
